...
class CopyJarDockerPlugin : Plugin<Project> {

    override fun apply(project: Project) {
        val extension = project.extensions.create<CopyJarDockerExtension>("dockerCopy")

        project.tasks.register<CopyJarDockerTask>("copyJarToDocker") {
            group = "nyaadanbou"
        ...
        project.afterEvaluate {
            project.configureTaskDependencies("copyJarToDocker")
        }
    }
}